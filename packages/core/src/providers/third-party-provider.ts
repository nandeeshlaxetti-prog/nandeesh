 ...
 */
export class ThirdPartyProvider implements CourtProvider {
  readonly name = 'Third Party Provider'
  readonly type = 'THIRD_PARTY' as const
  ...
  private async simulateThirdPartyApiDelay(min: number, max: number): Promise<void> {
